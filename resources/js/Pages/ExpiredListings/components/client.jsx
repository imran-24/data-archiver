...
import { getExpired } from "@/actions/get-red-flag";
import React, { useState } from "react";


const ExpiredListingsClient = ({ data, districts, upazilas, divisions }) => {
    
    const redListings = getExpired(data) || []
            ...
            {isEmpty ? (
                ...
                <div className="grid h-full pt-3 lg:grid-cols-2 grid-cols-1  gap-4">
                    ...
                    <Card className="flex flex-col gap-2 px-6 py-2">
                                <div className="font-medium ">Expired Listings</div>
                            </Card>
...
export default ExpiredListingsClient;
